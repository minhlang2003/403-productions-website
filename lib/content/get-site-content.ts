...
const query = `*[_type == "siteSettings"][0]{brand,brandDescriptor,navMeta,tagline,supportingLine,positioning,navigation,home,about,services,contact,pages,"featuredProjects": *[_type == "project" && featured == true]{title,subtitle,"slug":slug.current,year,category,tagline,featured}}`
